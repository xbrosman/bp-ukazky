/*
    bp_komunikacia/uring_example/uring_app.c
...
// Initialization and measurement run
...
// Function with Measurement procedure
int doMeasure()
{
    double time_taken = 0;
...
// Creates test data buffer for WRITE function
...
// Creates empty data buffer to be ready for READ function
...
// Realloc new testing data with different size
...
// Prepare new read buffer with different size
...
// Change buffer size for test data
...
// Function for WRITE op measurement
int writeToDev()
{
    size_t res;
...
// Function for READ op measurement
int readFromDev()
{
    size_t res;
...
// Function for run time measurement of READ or WRITE function
double measureFuncDuration(int (*func_ptr)(void))
{
    clock_t t;
    double time_taken;
